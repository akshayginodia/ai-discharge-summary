...
import io
# Ensure this library is installed: pip install audio-recorder-streamlit
...
def main():
    ...
    <style>
        ...
        /* General caption style - remove extra styling */
        .stCaption { color: #636e72; font-style: italic; margin-top: 0.5em; margin-bottom: 1em; }
        ...
        /* Style audio recorder - use default appearance primarily */
        div[data-testid="stAudioRecorder"] { margin-top: 0.5em; }
    </style>
    """, unsafe_allow_html=True)

    # --- Header Image ---
    if APP_HEADER_IMAGE_URL:
        # FIXED: Reverted to use_column_width=True as requested
        st.image(APP_HEADER_IMAGE_URL, use_column_width=True)
    # --- END Header Image ---
    ...
    if valid_visit_selected:
        ...
        with input_col2:
            ...
            # Simple caption hint below the recorder
            st.caption("Click default icon to Record/Stop. Icon changes during recording.")
    ...
    if not edit_value and st.session_state.processing_complete and not st.session_state.validation_error and "error" not in st.session_state.get('llm_summary', '').lower():
         ...
         st.session_state.edited_summary = edit_value # Sync state if initializing
    ...
    with edit_col:
        ...
        st.caption("Make final corrections here. The preview on the right updates as you type.")
